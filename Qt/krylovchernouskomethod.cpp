...
void KrylovChernouskoMethod::SetInitConditions(InitConditions conds)
{
...
QList<float> KrylovChernouskoMethod::GetIterationsCriterias()
{
...
void KrylovChernouskoMethod::Iteration()
{
    ...
    //    lastValues->p1 = -2 * lastValues->x1;
    //    lastValues->p2 = -2 * lastValues->x2;
...
//    auto value = Clamp(initConditions.minControl, initConditions.maxControl, p2);
    ...
    auto value = p2 * initConditions.k * initConditions.k;
